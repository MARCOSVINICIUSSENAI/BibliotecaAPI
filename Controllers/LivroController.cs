...
namespace BibliotecaAPI.Controllers
{
    ...
    {
        private readonly LivroRepositorio _LivroRepositorioepo;

        public LivroController(LivroRepositorio LivroRepositorioepo)
        {
            _LivroRepositorioepo = LivroRepositorioepo;
        }
        ...
        public ActionResult<List<Livro>> GetAll()
        {
            try
            {
                var livros = _LivroRepositorioepo.GetAll();
        ...
        public ActionResult<Livro> GetById(int id)
        {
            try
            {
                var livro = _LivroRepositorioepo.GetById(id);
        ...
        public ActionResult<object> Post([FromForm] LivroDto novoLivro)
        {
            try
            {
                ...
                _LivroRepositorioepo.Add(livro);
        ...
        public ActionResult<object> Put(int id, [FromForm] LivroDto livroAtualizado)
        {
            try
            {
                var livroExistente = _LivroRepositorioepo.GetById(id);
                ...
                _LivroRepositorioepo.Update(livroExistente);
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                ...
                _LivroRepositorioepo.Delete(id);
